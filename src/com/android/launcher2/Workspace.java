...
public class Workspace extends SmoothPagedView
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        cellCountX = PreferencesProvider.Interface.Homescreen.getCellCount(context,0);
        cellCountY = PreferencesProvider.Interface.Homescreen.getCellCount(context,1);
        a.recycle();
        ...
        mDefaultHomescreen = PreferencesProvider.Interface.Homescreen.getDefaultHomescreen(context,
                (int) Math.floor((double) mNumberHomescreens / 2) + 1) - 1;
        if (mDefaultHomescreen >= mNumberHomescreens) {
            mDefaultHomescreen = (int) Math.floor((double) mNumberHomescreens / 2);
        }
